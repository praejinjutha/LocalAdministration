    ...
    <div class="container">
      ...
      <span>ด้านกายภาพ</span>
          ...
          <a href="<?= site_url('Sec1/sub1p2') ?>">
            <button class="active">(๒) ลักษณะภูมิประเทศ</button>
          </a>
...
<h3>คำสั่งการทำงานของเมนู</h3>
            <label>ลักษณะภูมิประเทศ</label>
<textarea class="input-box" placeholder="กรอกรายละเอียดลักษณะภูมิประเทศ..." disabled></textarea>
<br>
...
function saveChanges() {
    // ปิดการแก้ไขหลังจากบันทึกข้อมูล
    document.querySelectorAll('.input-box').forEach(function(element) {
