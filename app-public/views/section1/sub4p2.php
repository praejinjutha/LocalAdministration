...
<td><input type="text" style="width: 90%; border: 1px solid #ccc; border-radius: 5px; padding: 5px; background-color: #f0f0f0;" placeholder="กรอกชื่อสถานที่"></td>
