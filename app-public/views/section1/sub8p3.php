    ...
    <div class="menu">
        <button class="custom-btn">(๘) ทรัพยากรธรรมชาติ</button>
          ...
          <a href="<?= site_url('Sec1/sub8p3') ?>">
            <button class="active">(๓) ภูเขา</button>
          </a>
          <a href="<?= site_url('Sec1/sub8p4') ?>">
            <button>(๔) ทรัพยากรธรรมชาติที่สำคัญขององค์กร
...
<td><input type="text" style="width: 90%; border: 1px solid #ccc; border-radius: 5px; padding: 5px; background-color: #f0f0f0;" placeholder="กรอกรายการ"></td>
...
function addRow() {
    ...
    cell2.innerHTML = `<input type="text" style="width:90%; border: 1px solid #ccc; border-radius: 5px; padding: 5px;" placeholder="กรอกรายการ">`;
