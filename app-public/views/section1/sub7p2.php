    ...
    <div class="menu">
        <button class="custom-btn">(๗) ศาสนา ประเพณี วัฒนธรรม</button>
          ...
          <a href="<?= site_url('Sec1/sub7p2') ?>">
            <button class="active">(๒) ประเพณีและงานประจำปี</button>
          </a>
...
<h3>คำสั่งการทำงานของเมนู</h3>
            <label>ประเพณีและงานประจำปี</label>
<textarea class="input-box" placeholder="กรอกรายละเอียดประเพณีและงานประจำปี..." disabled></textarea>
<br>
