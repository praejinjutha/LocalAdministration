...
<div class="navbar">
    ...
    <a href="<?= site_url('Sec1/sub6p1') ?>">
            <button class="active">(๑) การเกษตร</button>
          </a>
          <a href="<?= site_url('Sec1/sub6p2') ?>">
            <button>(๒) การประมง</button>
          </a>
          <a href="<?= site_url('Sec1/sub6p3') ?>">
            <button>(๓) การปศุสัตว์</button>
          </a>
          <a href="<?= site_url('Sec1/sub6p4') ?>">
            <button>(๔) การบริการ</button>
          </a>
          <a href="<?= site_url('Sec1/sub6p5') ?>">
            <button>(๕) การท่องเที่ยว</button>
          </a>
          <a href="<?= site_url('Sec1/sub6p6') ?>">
            <button>(๖) อุตสาหกรรม</button>
          </a>
          <a href="<?= site_url('Sec1/sub6p7') ?>">
            <button>(๗) การพาณิชย์และกลุ่มอาชีพ</button>
          </a>
...
<h3>คำสั่งการทำงานของเมนู</h3>
            <label>การเกษตร</label>
<textarea class="input-box" placeholder="กรอกรายละเอียดการเกษตร..." disabled></textarea>
<br>
