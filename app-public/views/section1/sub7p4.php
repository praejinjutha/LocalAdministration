...
<div class="navbar">
    ...
    <a href="<?= site_url('Sec1/sub7p1') ?>">
          ...
          <a href="<?= site_url('Sec1/sub7p3') ?>">
            <button>(๓) ภูมิปัญญาท้องถิ่น</button>
          </a>
          <a href="<?= site_url('Sec1/sub7p4') ?>">
            <button class="active">(๔) OTOP สินค้าพื้นเมืองและของที่ระลึก</button>
          </a>
        </div>
...
<h3>คำสั่งการทำงานของเมนู</h3>
            <label>OTOP สินค้าพื้นเมืองและของที่ระลึก</label>
<textarea class="input-box" placeholder="กรอกรายละเอียด OTOP สินค้าพื้นเมืองและของที่ระลึก..." disabled></textarea>
<br>
