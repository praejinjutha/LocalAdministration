...
<td><input type="text" style="width: 90%; border: 1px solid #ccc; border-radius: 5px; padding: 5px; background-color: #f0f0f0;" placeholder="กรอกหมู่"></td>
...
<div class="delete-modal-overlay" style="display: none;">
    <div class="delete-modal-container">
        ...
        <div class="delete-modal-message">คุณแน่ใจหรือไม่ว่าต้องการลบรายการนี้ ?</div>
...
<script>
let isEditable = false;  // ตัวแปรตรวจสอบสถานะการแก้ไข
let deleteTargetRow = null; // เก็บแถวที่ต้องการลบ

// ฟังก์ชันแสดงป๊อปอัปยืนยันการลบ
...
function addRow() {
    ...
    cell1.innerHTML = `<input type="text" style="width:90%; border: 1px solid #ccc; border-radius: 5px; padding: 5px;" placeholder="กรอกชื่อ">`;

    let cell2 = newRow.insertCell(2);
    cell2.innerHTML = `<input type="text" style="width:90%; border: 1px solid #ccc; border-radius: 5px; padding: 5px;" placeholder="กรอกหมู่">`;
    ...
    cell4.innerHTML = `<button class="btn-delete" onclick="confirmDelete(this)" disabled>ลบ</button>`;

    if (isEditable) {
        cell4.querySelector('button').disabled = false;
    }
}
