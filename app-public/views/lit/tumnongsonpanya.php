...
<head>
  ...
  <link href="/Thai/assets/img/apple-touch-icon.png" rel="apple-touch-icon">
...
<link href="https://fonts.googleapis.com/css2?family=Niramit:wght@500&family=Thasadith:wght@700&display=swap" rel="stylesheet">
  ...
  <!-- Vendor CSS Files -->
  <link href="/Thai/assets/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
  <link href="/Thai/assets/vendor/bootstrap-icons/bootstrap-icons.css" rel="stylesheet">
  <link href="/Thai/assets/vendor/aos/aos.css" rel="stylesheet">
  <link href="/Thai/assets/vendor/glightbox/css/glightbox.min.css" rel="stylesheet">
  <link href="/Thai/assets/vendor/swiper/swiper-bundle.min.css" rel="stylesheet">
  <link href="/Thai/assets/vendor/remixicon/remixicon.css" rel="stylesheet">

  <!-- Template Main CSS File -->
  <link href="/Thai/assets/css/main.css" rel="stylesheet">
</head>
...
<body class="page-portfolio">
  ...
  <header id="header" class="header d-flex align-items-center fixed-top">
    ...
    <img src="/Thai/assets/img/logo.png" alt="">
</a>
      </a>
  ...
  <main id="main">
    <!-- ======= Breadcrumbs ======= -->
        ...
        <img src="/Thai/assets/img/navbar.png" alt="Navbar" style="width: 100%; height: auto;">
</main>
...
<div class="container py-5">
                ...
                <div class="d-flex flex-column text-left mb-3" style="margin-left: 30px;">
                    ...
                    <div class="mb-5">
                        ...
                        if ($tumnongsonpanya == 1) {
                            $audio_file = "/Thai/assets/audio/second3lines/tumnongsonpanya1.wav";
                        } elseif ($tumnongsonpanya == 2) {
                            $audio_file = "/Thai/assets/audio/second3lines/tumnongsonpanya2.wav";
                        } elseif ($tumnongsonpanya == 3) {
                            $audio_file = "/Thai/assets/audio/second3lines/tumnongsonpanya3.wav";
                        } elseif ($tumnongsonpanya == 4) {
                            $audio_file = "/Thai/assets/audio/second3lines/tumnongsonpanya4.wav";
                        } elseif ($tumnongsonpanya == 5) {
                            $audio_file = "/Thai/assets/audio/second3lines/tumnongsonpanya5.wav";
                        } elseif ($tumnongsonpanya == 6) {
                            $audio_file = "/Thai/assets/audio/second3lines/tumnongsonpanya6.wav";
                        } elseif ($tumnongsonpanya == 7) {
                            $audio_file = "/Thai/assets/audio/second3lines/tumnongsonpanya7.wav";
                        } elseif ($tumnongsonpanya == 8) {
                            $audio_file = "/Thai/assets/audio/second3lines/tumnongsonpanya8.wav";
                        } elseif ($tumnongsonpanya == 9) {
                            $audio_file = "/Thai/assets/audio/second3lines/tumnongsonpanya9.wav";
                        } elseif ($tumnongsonpanya == 10) {
                            $audio_file = "/Thai/assets/audio/second3lines/tumnongsonpanya10.wav";
                        } elseif ($tumnongsonpanya == 11) {
                            $audio_file = "/Thai/assets/audio/second3lines/tumnongsonpanya11.wav";
                        } elseif ($tumnongsonpanya == 12) {
                            $audio_file = "/Thai/assets/audio/second3lines/tumnongsonpanya12.wav";
                        } elseif ($tumnongsonpanya == 13) {
                            $audio_file = "/Thai/assets/audio/second3lines/tumnongsonpanya13.wav";
                        } 
                        ?>
  ...
  <!-- Vendor JS Files -->
  <script src="/Thai/assets/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
  <script src="/Thai/assets/vendor/aos/aos.js"></script>
  <script src="/Thai/assets/vendor/glightbox/js/glightbox.min.js"></script>
  <script src="/Thai/assets/vendor/swiper/swiper-bundle.min.js"></script>
  <script src="/Thai/assets/vendor/isotope-layout/isotope.pkgd.min.js"></script>
  <script src="/Thai/assets/vendor/php-email-form/validate.js"></script>



  <!-- Template Main JS File -->
  <script src="/Thai/assets/js/main.js"></script>
