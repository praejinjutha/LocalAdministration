...
if (empty($botdoksoi) || $botdoksoi == 1) {
  $botdoksoi = 1;
  $image_file = "/Thai/assets/img/literature/kapyani/botdoksoi1.jpg";
  $botdoksoi_title = "แมวเหมียว";
} elseif ($botdoksoi == 2) {
    $image_file = "/Thai/assets/img/literature/kapyani/botdoksoi2.jpg";
    $botdoksoi_title = "นกเอี้ยงเลี้ยงควายเฒ่า";
} elseif ($botdoksoi == 3) {
    $image_file = "/Thai/assets/img/literature/kapyani/botdoksoi3.jpg";
            ...
            <?php if (!empty($botdoksoi)) : ?>
                <div class="d-flex flex-column text-left mb-3" style="margin-left: 30px;">
                    ...
                    <div class="mb-5">
                        ...
                        $audio_file = '';
                        if ($botdoksoi == 1) {
                            $audio_file = "/Thai/assets/audio/first2lines/botdoksoi1.wav";
                        } elseif ($botdoksoi == 2) {
                            $audio_file = "/Thai/assets/audio/first2lines/botdoksoi2.wav";
                        } elseif ($botdoksoi == 3) {
                            $audio_file = "/Thai/assets/audio/first2lines/botdoksoi3.wav";
                        } 
                        ?>
