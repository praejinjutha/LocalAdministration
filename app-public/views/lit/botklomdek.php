...
if (empty($botklomdek) || $botklomdek == 1) {
  $botklomdek = 1;
  $image_file = "/Thai/assets/img/literature/kapyani/botklomdek1.jpg";
  $botklomdek_title = "เจ้าทองคำ";
} elseif ($botklomdek == 2) {
    $image_file = "/Thai/assets/img/literature/kapyani/botklomdek2.jpg";
    $botklomdek_title = "เจ้าเนื้อละมุน";
} elseif ($botklomdek == 3) {
    $image_file = "/Thai/assets/img/literature/kapyani/botklomdek3.jpg";
    $botklomdek_title = "เจ้าเนื้ออ่อน";
} elseif ($botklomdek == 4) {
    $image_file = "/Thai/assets/img/literature/kapyani/botklomdek4.jpg";
    $botklomdek_title = "ตุ๊กแก";
} elseif ($botklomdek == 5) {
    $image_file = "/Thai/assets/img/literature/kapyani/botklomdek5.jpg";
            ...
            <?php if (!empty($botklomdek)) : ?>
                <div class="d-flex flex-column text-left mb-3" style="margin-left: 30px;">
                    ...
                    <div class="mb-5">
                        ...
                        $audio_file = '';
                        if ($botklomdek == 1) {
                            $audio_file = "/Thai/assets/audio/first2lines/botklomdek1.wav";
                        } elseif ($botklomdek == 2) {
                            $audio_file = "/Thai/assets/audio/first2lines/botklomdek2.wav";
                        } elseif ($botklomdek == 3) {
                            $audio_file = "/Thai/assets/audio/first2lines/botklomdek3.wav";
                        } elseif ($botklomdek == 4) {
                            $audio_file = "/Thai/assets/audio/first2lines/botklomdek4.wav";
                        } elseif ($botklomdek == 5) {
                            $audio_file = "/Thai/assets/audio/first2lines/botklomdek5.wav";
                        } 
                        ?>
