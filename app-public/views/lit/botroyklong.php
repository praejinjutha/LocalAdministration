...
if (empty($botroyklong) || $botroyklong == 1) {
  $botroyklong = 1;
  $image_file = "/Thai/assets/img/literature/kapyani/botroyklong1.jpg";
  $botroyklong_title = "เคยไหม";
} elseif ($botroyklong == 2) {
    $image_file = "/Thai/assets/img/literature/kapyani/botroyklong2.jpg";
    $botroyklong_title = "บ่าย. ลม. บ่ม. ร้อน.";
} elseif ($botroyklong == 3) {
    $image_file = "/Thai/assets/img/literature/kapyani/botroyklong3.jpg";
    $botroyklong_title = "แปลงอุดมการณ์เป็นชีวิต";
} elseif ($botroyklong == 4) {
    $image_file = "/Thai/assets/img/literature/kapyani/botroyklong4.jpg";
    $botroyklong_title = "ผู้ใหญ่";
} elseif ($botroyklong == 5) {
    $image_file = "/Thai/assets/img/literature/kapyani/botroyklong5.jpg";
            ...
            <?php if (!empty($botroyklong)) : ?>
                <div class="d-flex flex-column text-left mb-3" style="margin-left: 30px;">
                    ...
                    <div class="mb-5">
                        ...
                        $audio_file = '';
                        if ($botroyklong == 1) {
                            $audio_file = "/Thai/assets/audio/second3lines/botroyklong1.wav";
                        } elseif ($botroyklong == 2) {
                            $audio_file = "/Thai/assets/audio/second3lines/botroyklong2.wav";
                        } elseif ($botroyklong == 3) {
                            $audio_file = "/Thai/assets/audio/second3lines/botroyklong3.wav";
                        } elseif ($botroyklong == 4) {
                            $audio_file = "/Thai/assets/audio/second3lines/botroyklong4.wav";
                        } elseif ($botroyklong == 5) {
                            $audio_file = "/Thai/assets/audio/second3lines/botroyklong5.wav";
                        } 
                        ?>
