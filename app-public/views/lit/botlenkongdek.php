...
if (empty($botlenkongdek) || $botlenkongdek == 1) {
  $botlenkongdek = 1;
  $image_file = "/Thai/assets/img/literature/pros/botlenkongdek1.jpg";
  $botlenkongdek_title = "เพลงช้าง";
} elseif ($botlenkongdek == 2) {
    $image_file = "/Thai/assets/img/literature/pros/botlenkongdek2.jpg";
    $botlenkongdek_title = "เพลงจับปูนา";
} elseif ($botlenkongdek == 3) {
    $image_file = "/Thai/assets/img/literature/pros/botlenkongdek3.jpg";
    $botlenkongdek_title = "โรงเรียนสะอาด";
} elseif ($botlenkongdek == 4) {
    $image_file = "/Thai/assets/img/literature/pros/botlenkongdek4.jpg";
    $botlenkongdek_title = "ใครหนอ";
} elseif ($botlenkongdek == 5) {
    $image_file = "/Thai/assets/img/literature/pros/botlenkongdek5.jpg";
    $botlenkongdek_title = "เพลงแมงมุม";
} elseif ($botlenkongdek == 6) {
    $image_file = "/Thai/assets/img/literature/pros/botlenkongdek6.jpg";
    $botlenkongdek_title = "เพลงแม่งูเอ๋ย";
} elseif ($botlenkongdek == 7) {
    $image_file = "/Thai/assets/img/literature/pros/botlenkongdek7.jpg";
            ...
            <?php if (!empty($botlenkongdek)) : ?>
                <div class="d-flex flex-column text-left mb-3" style="margin-left: 30px;">
                    ...
                    <div class="mb-5">
                        ...
                        $audio_file = '';
                        if ($botlenkongdek == 1) {
                            $audio_file = "/Thai/assets/audio/first2lines/botlenkongdek1.wav";
                        } elseif ($botlenkongdek == 2) {
                            $audio_file = "/Thai/assets/audio/first2lines/botlenkongdek2.wav";
                        } elseif ($botlenkongdek == 3) {
                            $audio_file = "/Thai/assets/audio/first2lines/botlenkongdek3.wav";
                        } elseif ($botlenkongdek == 4) {
                            $audio_file = "/Thai/assets/audio/first2lines/botlenkongdek4.wav";
                        } elseif ($botlenkongdek == 5) {
                            $audio_file = "/Thai/assets/audio/first2lines/botlenkongdek5.wav";
                        } elseif ($botlenkongdek == 6) {
                            $audio_file = "/Thai/assets/audio/first2lines/botlenkongdek6.wav";
                        } elseif ($botlenkongdek == 7) {
                            $audio_file = "/Thai/assets/audio/first2lines/botlenkongdek7.wav";
                        } 
                        ?>
