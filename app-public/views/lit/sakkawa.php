...
if (empty($sakkawa) || $sakkawa == 1) {
  $sakkawa = 1;
  $image_file = "/Thai/assets/img/literature/kapyani/sakkawa1.jpg";
  $sakkawa_title = "บทสักวาหวานอื่นมีหมื่นแสน";
} elseif ($sakkawa == 2) {
    $image_file = "/Thai/assets/img/literature/kapyani/sakkawa2.jpg";
    $sakkawa_title = "บทสักวาดาวจระเข้";
} elseif ($sakkawa == 3) {
    $image_file = "/Thai/assets/img/literature/kapyani/sakkawa3.jpg";
    $sakkawa_title = "บทสักวาน้ำขึ้นให้รีบตัก";
} elseif ($sakkawa == 4) {
    $image_file = "/Thai/assets/img/literature/kapyani/sakkawa4.jpg";
    $sakkawa_title = "แต่งให้งามตามที่เหมาะ";
} elseif ($sakkawa == 5) {
    $image_file = "/Thai/assets/img/literature/kapyani/sakkawa5.jpg";
            ...
            <?php if (!empty($sakkawa)) : ?>
                <div class="d-flex flex-column text-left mb-3" style="margin-left: 30px;">
                    ...
                    <div class="mb-5">
                        ...
                        $audio_file = '';
                        if ($sakkawa == 1) {
                            $audio_file = "/Thai/assets/audio/second3lines/sakkawa1.wav";
                        } elseif ($sakkawa == 2) {
                            $audio_file = "/Thai/assets/audio/second3lines/sakkawa2.wav";
                        } elseif ($sakkawa == 3) {
                            $audio_file = "/Thai/assets/audio/second3lines/sakkawa3.wav";
                        } elseif ($sakkawa == 4) {
                            $audio_file = "/Thai/assets/audio/second3lines/sakkawa4.wav";
                        } elseif ($sakkawa == 5) {
                            $audio_file = "/Thai/assets/audio/second3lines/sakkawa5.wav";
                        } 
                        ?>
