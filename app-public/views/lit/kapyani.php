...
if (empty($kapyani) || $kapyani == 1) {
  $kapyani = 1;
  $image_file = "/Thai/assets/img/literature/kapyani/kapyani1.jpg";
  $kapyani_title = "แมว";
} elseif ($kapyani == 2) {
    $image_file = "/Thai/assets/img/literature/kapyani/kapyani2.jpg";
    $kapyani_title = "ไก่งามเพราะขน คนงามเพราะแต่ง";
} elseif ($kapyani == 3) {
    $image_file = "/Thai/assets/img/literature/kapyani/kapyani3.jpg";
            ...
            <?php if (!empty($kapyani)) : ?>
                <div class="d-flex flex-column text-left mb-3" style="margin-left: 30px;">
                    ...
                    <div class="mb-5">
                        ...
                        $audio_file = '';
                        if ($kapyani == 1) {
                            $audio_file = "/Thai/assets/audio/first2lines/kapyani1.wav";
                        } elseif ($kapyani == 2) {
                            $audio_file = "/Thai/assets/audio/first2lines/kapyani2.wav";
                        } elseif ($kapyani == 3) {
                            $audio_file = "/Thai/assets/audio/first2lines/kapyani3.wav";
                        } 
                        ?>
